...
public class PcMemberService {
	...
	public String getWyCountByAgencyId(int agencyId) {		
		Integer count = 0;
		count = pcMemberDaoImpl.getWyCountByAgencyId(agencyId);
		        ...
		        if (memberList != null && memberList.size() > 0) {
					for (PcMember member : memberList) {
				        ...
				        if (member.getBirthday() != null) {
					        Label label4 = new Label(5, index_y_col, formatNowYear.format(member.getBirthday())); 
				        ...
				        if (member.getWorkday() != null) {
					        Label label6 = new Label(7, index_y_col, formatNowYear.format(member.getWorkday())); 
				        ...
				        if (member.getJoinday() != null) {
					        Label label9 = new Label(10, index_y_col, formatNowYear.format(member.getJoinday())); 
				        ...
				        if (member.getPostday() != null) {
					        Label label10 = new Label(11, index_y_col, formatNowYear.format(member.getPostday())); 
