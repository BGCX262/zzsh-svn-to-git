...
begin
	...
	DECLARE s_cursor CURSOR FOR SELECT id, name, code_id, code, parent_id FROM  pc_agency WHERE code_id = 10 and invalid_datetime = 0;
...
begin
	...
	DECLARE s_cursor CURSOR FOR SELECT id, name, code_id, code, parent_id FROM  pc_agency WHERE code_id in (7,8,15) and invalid_datetime = 0;
	DECLARE CONTINUE HANDLER FOR NOT FOUND SET done=1;
