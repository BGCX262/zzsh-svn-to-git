package com.partycommittee.proxy
{
	...
	public class PcAgencyProxy extends BaseProxy {
		...
		public function getChildrenRevert(agencyId:Number):void {
			service.getChildrenRevert(agencyId);
		}		
		...
		public function revertAgency(agency:PcAgencyVo):void {
			service.revertAgency(agency);
		}		
		
		public function getAgencyCount():void {
			service.getAgencyCount();
		}	
		
		public function getAgencyDwCount():void {
			service.getAgencyDwCount();
		}		
