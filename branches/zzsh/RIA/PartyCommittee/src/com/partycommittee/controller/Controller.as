package com.partycommittee.controller
{
	...
	import com.partycommittee.commands.PcCommonCommand;
	...
	import com.partycommittee.commands.PcWordCommand;
	import com.partycommittee.commands.PcWorkPlanCommand;
	import com.partycommittee.commands.PcLicenseCommand;
	...
	public class Controller extends FrontController {
		...
		private function init():void {
			addCommand(PcCommonEvent.PCCOMMON_EVENT, PcCommonCommand);
			...
			addCommand(PcWordEvent.PCWORD_EVENT, PcWordCommand);
			addCommand(PcLicenseEvent.PCLICENSE_EVENT, PcLicenseCommand);
		}
	}
