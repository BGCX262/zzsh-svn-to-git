package com.partycommittee.control.tree {
    ...
    */
   public class LoadingTreeRevert extends AutoSizeTree {
      ...
      * Constructor
      */
      public function LoadingTreeRevert() {
         super();

         doubleClickEnabled = true;

         // Below is default set for loading tree.
         iconFunction = LoadingTreeRevertIconFunction;
		 labelFunction = LoadingTreeRevertLabelFunction;
...
//         addEventListener(AdvancedMouseEvent.RIGHT_MOUSE_DOWN, onMenuSelectedHandler);
      ...
      */
      ...
      protected function callRemoteService(node:Node):void {
		 ...
		 var agencyEvent:PcAgencyEvent = new PcAgencyEvent(PcAgencyEvent.GET_CHILDREN_REVERT);
      ...
      */
      ...
      /**
      * LoadingTreeRevert Icon Function
      */
      private function LoadingTreeRevertIconFunction(item:Object):Class {
         return item.icon;
      }
	  
	  /**
	   * LoadingTreeRevert Label Function
	   */
	  private function LoadingTreeRevertLabelFunction(item:Object):String {
