	...
	public class PcAgencyCommand extends BaseCommand implements IResponder {
		...
		override public function execute(event:CairngormEvent):void {
			...
			switch (pcAgencyEvent.kind) {
				...
				case PcAgencyEvent.GET_ROOT_HISTORY_AGENCY_BY_USERID:
				...
				case PcAgencyEvent.GET_CHILDREN:
					...
					break;
				case PcAgencyEvent.GET_CHILDREN_REVERT:
					pcAgencyProxy.getChildrenRevert(pcAgencyEvent.agency.id);
					break;				
				...
				case PcAgencyEvent.GET_PARENT:
					...
					break;
				case PcAgencyEvent.DO_REVERT:
					pcAgencyProxy.revertAgency(pcAgencyEvent.agency);
					break;				
				case PcAgencyEvent.GET_AGENCY_COUNT :
					pcAgencyProxy.getAgencyCount();
					break;
				case PcAgencyEvent.GET_AGENCY_DW_COUNT :
					pcAgencyProxy.getAgencyDwCount();
					break;				
				default :
					break;
			}
